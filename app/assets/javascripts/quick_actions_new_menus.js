// all the menus in QuickActions being written in css+html instead of html+select tag
// closure to avoid global var pollution
(function(){
    var quickActionsMenusExperiment = rendererModel && rendererModel.runningExperiments && (rendererModel.runningExperiments.QuickActionsMenus || rendererModel.runningExperiments.quickactionsmenus);
    var experimentalMenusRunning = quickActionsMenusExperiment && ((quickActionsMenusExperiment).toLowerCase() === "new");
    WQuickActions.newMenus = experimentalMenusRunning;
})();

if(WQuickActions.newMenus){
    WQuickActions = {
        ...
        _initMenu: function(menu, menuButton, oldMenuButton){
            ...
            // hide old button
            this.addClass(oldMenuButton, 'qa-new-menus-hide');
        ...
        _initPagesMenu: function(){
            var menu = document.getElementById("qa-drop-up-pages"),
                ...
                oldMenuButton = document.getElementById("quick-actions-site-nav");

            if(!(menu && menuButton && oldMenuButton)){
                return false;
            }

            this._initMenu(menu, menuButton, oldMenuButton);
        },
        ...
        _initSocialMenu: function(){
            var menu = document.getElementById("qa-drop-up-social"),
                ...
                oldMenuButton = document.getElementById("quick-actions-social");
        ...
        fixZoom: function(){
            ...
            var zoom = this.initZoom / this.getZoom();
